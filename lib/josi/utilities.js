...
Array.prototype.contains = function(item) {
  return this.filter(function(t) { return t === item; }).length > 0;
};

this.argumentsToArray = function(args) {
  var arr = [];
  for (var a in args) {
    arr.push(args[a]);
  }
...
this.serveFile = function(req, res, filename) {
  ...
  var body, headers;
  var contentType = mime.lookup(extension(filename));
